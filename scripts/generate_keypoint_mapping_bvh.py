...
from general_motion_retargeting.optimize_human_scale import optimize_human_scale_table
from general_motion_retargeting.fk_solver import MuJoCoFK
from general_motion_retargeting.data_processor import load_robot_init, scale_human_data, align_robot_data, offset_human_data, write_all_data_to_ik
from general_motion_retargeting.compute_offsets import compute_position_offsets, compute_quaternion_offsets
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        choices=["unitree_g1", "unitree_g1_with_hands", "unitree_h1", "unitree_h1_2",
                 ...
                 "openloong", "tienkung","joyin","joyin_add","joyin_human"],
        default="unitree_g1",
    )
    ...
    quat_offsets = {}
    print("=== 计算四元数偏移 ===")
    print("human",scaled_human_data)
    print("robot",fk_solver.body_names)
    quat_offsets, missing_links = compute_quaternion_offsets(
        scaled_human_data,
        centers, Rs, fk_solver.body_names, 
        ik_cfg_tmp
    )
    print("quat_offsets",quat_offsets)
